...
int main(void) {
  ...
  //   Create_text_buffer = dlsym(buffer_extension_pointer,
  //   "TextBuffer_Create"); Get_Character_from_text_buffer =
  ...
  //   Delete_text_buffer = dlsym(buffer_extension_pointer,
  //   "TextBuffer_Delete");
  ...
  //             "\"%s\"\n",
  //             file_buffer, file_buffer->size,
  //             file_buffer->size_in_characters, file_name);
